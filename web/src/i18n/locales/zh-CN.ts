export default {
    ...
    videoWorkbench: {
        ...
        materialsPrivacy: "参考素材经站点素材通道直传，约 3 小时后自动删除；生成结果不受影响",
        materialRetry: "重新上传",
